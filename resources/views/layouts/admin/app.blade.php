...
<head>
   ...
   <body>
      ...
      <script src="{{asset('dashboard/assets/js/vendors/jquery.min.js')}}"></script>
      <script src="{{asset('dashboard/assets/js/vendors/countdown.js')}}"></script>
      <script src="{{asset('dashboard/assets/libs/slick-carousel/slick/slick.min.js')}}"></script>
      <script src="{{asset('dashboard/assets/js/vendors/slick-slider.js')}}"></script>
      <script src="{{asset('dashboard/assets/libs/tiny-slider/dist/min/tiny-slider.js')}}"></script>
      <script src="{{asset('dashboard/assets/js/vendors/tns-slider.js')}}"></script>
      <script src="{{asset('dashboard/assets/js/vendors/zoom.js')}}"></script>
   </body>
